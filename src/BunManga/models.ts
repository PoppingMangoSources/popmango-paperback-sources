 ...
 *
 * Past the first page the site answers through its load-more endpoint, which
 * wants the opaque query blob the first page embedded. `total` is kept so the
 * end of a listing can be recognised without fetching an empty page.
 */
