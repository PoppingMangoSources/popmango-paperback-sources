...
import { Application, PaperbackInterceptor, type InterceptedRequest } from "../../common";
 ...
 *
 * The slash in a name like "Manhwa/Manhua" has to stay literal because the
 * server expects it there, while spaces in names such as "Martial Arts" are
 * still encoded.
 */
export function genreUrl(baseUrl: string, name: string): string {
